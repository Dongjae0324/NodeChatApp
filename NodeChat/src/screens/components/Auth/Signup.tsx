    ...
    return(
        <SafeAreaView style={styles.container}>
            ...
            <View style={{width: "80%", paddingTop: 20}}>
                ...
                <Input type={pwInput.type} secureTextEntry={true} value={pwInput.value} placeholder={"비밀번호를 입력해주세요"} onChangeText={(val)=>{setPwInput({type:"noError", value:val})}}/>
            ...
            <TouchableOpacity onPress={()=>{register()}} style={{position: 'absolute', backgroundColor: '#1b4332', bottom: 40, width: "80%", borderRadius: 20, alignItems: 'center', justifyContent: 'center'}}>
